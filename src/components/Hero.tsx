        ...
        >
          <div className="  w-full ">
            ...
            <img
              src={Avatar}
              alt="hero avatar"
              className=" hidden md:block w-60 rounded-full aspect-square object-cover object-top float-left [shape-outside:circle(50%)] mr-6"
            />
            <p className="mb-8 text-lg text-gray-300 max-w-2xl">
              ...
              frameworks, I build responsive, high-performance web applications that users love. I create exceptional
              digital experiences with clean, efficient code. Specializing in modern JavaScript frameworks, I build
              responsive, high-performance web applications that users love. I create exceptional digital experiences
              with clean, efficient code. Specializing in modern JavaScript frameworks, I build responsive,
              high-performance web applications that users love. I create exceptional digital experiences with clean,
              efficient code. Specializing in modern JavaScript frameworks, I build responsive, high-performance web
